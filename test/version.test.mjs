...
test("i file nuovi stanno nella shell del service worker", () => {
  const sw = readFileSync(new URL("../sw.js", import.meta.url), "utf8");
  for (const f of ["./js/notify.js", "./js/share.js", "./js/game.js", "./js/vengeance.js", "./js/views/table.js", "./js/views/profile.js", "./js/views/elo-report.js"]) assert.ok(sw.includes(`"${f}"`), f);
});
